...
<header>
	<div class="container-fluid">
		...
		<nav class="navbar animated fadeIn navbar-fixed-top">
			<!-- Collapse button-->
			<a class="navbar-brand " href="<?php echo"$local_host_name"?>/VivahIndex.php"><img src="<?php echo"$local_host_name"?>/img/images/Logo.png" alt="Vivah Brand Name"></a>
				...
				<div class="collapse navbar-toggleable-xs" id="MobileView_Bar">
					...
					<ul class="nav navbar-nav pull-right">
						<li class="nav-item active">
							<a class="nav-link" href="<?php echo"$local_host_name"?>/index.php"">Home</a>
						</li>
						<li class="nav-item">
