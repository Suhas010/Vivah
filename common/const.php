...
$local_host_name="http://localhost/Vivah_MDB";
$header_file_path=join("//", array(dirname(__FILE__),'header.php'));
$footer_file_path=join("//", array(dirname(__FILE__),'footer.php'));
$master_header_path=join("//", array(dirname(__FILE__),'masterheader.php'));
?>