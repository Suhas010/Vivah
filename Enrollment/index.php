...
<div class="col-md-3 ">
    ...
    <div class="card card-cascade">
		...
		<div class="bst1">BEST SELLER</div>

        <!--Card content-->
        <div class="card-block text-xs-center">
            <!--Title--><br>
            <h2 class="card-title"><strong>Basic</strong></h2>
            <h5>plan</h5>

            <p class="card-text"><b>Starts at</b><br><i class="fa fa-inr" aria-hidden="true"></i>&nbsp;100/10 days
            </p>
			<ul>
				<li>25 Contacts To View</li>
...
<div class="col-md-3">
    ...
    <!--Card-->
    <div class="card card-cascade">
		<div class="bst2">MOST POPULAR!</div>

        <!--Card content--><br>
        <div class="card-block text-xs-center">
            <!--Title-->
            <h2 class="card-title"><strong>Platinum</strong></h2>
            <h5>plan</h5>

            <p class="card-text"><b>Starts at</b><br><i class="fa fa-inr" aria-hidden="true"></i>&nbsp;300/20 days
            </p>
			<ul>
				<li>45 Contacts To View</li>
				<li>Send Personalized Messages</li>
				<li>View contacts of members you like</li>
			</ul>
			<button type="button" class="btn btn-success">Buy Now</button>
...
<div class="col-md-3">
    ...
    <div class="card card-cascade">
       ...
       <div class="bst3">POPULAR</div>

        <!--Card content--><br>
        <div class="card-block text-xs-center">
            <!--Title-->
            <h2 class="card-title"><strong>Silver</strong></h2>
            <h5>plan</h5>

			<p class="card-text"><b>Starts at</b><br><i class="fa fa-inr" aria-hidden="true"></i>&nbsp;500/month
            </p>
			<ul>
				<li>85 Contacts To View</li>
				<li>Send Personalized Messages</li>
				<li>View contacts of members you like</li>
			</ul>
			<button type="button" class="btn btn-success">Buy Now</button>
...
<div class="col-md-3">
    ...
    <div class="card card-cascade">
        ...
        <div class="bst4">SELLER</div>
        <!--Card content--><br>
        <div class="card-block text-xs-center">
            <!--Title-->
            <h2 class="card-title"><strong>Gold</strong></h2>
            <h5>plan</h5>

            <p class="card-text"><b>Starts at</b><br><i class="fa fa-inr" aria-hidden="true"></i>&nbsp;1000/6 month
            </p>
			<ul>
				<li>200 Contacts To View</li>
				<li>Send Personalized Messages</li>
				<li>View contacts of members you like</li>
			</ul>
			<button type="button" class="btn btn-success">Buy Now</button>
